    ...
    lessons: [
      {
        ...
        quiz: [
          { q: '« Les résultats ___ encourageants. »', options: ['est', 'sont', 'être'], answer: 1, explain: 'Sujet pluriel → sont.' },
          { q: '« C’est nous qui ___ responsables. »', options: ['est', 'sommes', 'sont'], answer: 1, explain: 'Antécédent = nous → sommes.' },
          { q: '« La majorité des candidats ___ réussi. »', options: ['a', 'ont', 'avoir'], answer: 0, explain: 'Sujet = la majorité (singulier) → a.' },
          { q: '« Ce sont eux qui ___ décidé. »', options: ['a', 'ont', 'avons'], answer: 1, explain: 'Antécédent = eux → ont.' },
          { q: '« Peu d’étudiants ___ présents. »', options: ['était', 'étaient', 'été'], answer: 1, explain: 'Peu de + pluriel → étaient.' },
        ],
      },
      {
        id: 'accords-adj',
        ...
        quiz: [
          { q: '« Des mesures ___ ont été prises. »', options: ['strict', 'strictes', 'stricte'], answer: 1, explain: 'Féminin pluriel → strictes.' },
          { q: '« Elle est restée ___ . »', options: ['calme', 'calmes', 'calmé'], answer: 0, explain: 'Elle → calme.' },
          { q: '« Des chaussures ___ . »', options: ['bleues foncées', 'bleu foncé', 'bleus foncés'], answer: 1, explain: 'Couleur composée souvent invariable.' },
          { q: '« Une décision ___ et ___ . »', options: ['juste / rapide', 'juste / rapides', 'justes / rapide'], answer: 0, explain: 'Accord avec décision (fém. sing.).' },
        ],
      },
      {
        id: 'accords-pp',
        ...
        quiz: [
          { q: '« Les décisions qu’ils ont ___ . »', options: ['pris', 'prise', 'prises'], answer: 2, explain: 'COD fém. plur. avant → prises.' },
          { q: '« Elle est ___ hier. »', options: ['parti', 'partie', 'partis'], answer: 1, explain: 'être + elle → partie.' },
          { q: '« Les erreurs que j’ai ___ . »', options: ['fait', 'faite', 'faites'], answer: 2, explain: 'COD = les erreurs avant → faites.' },
          { q: '« Elle s’est ___ les mains. »', options: ['lavée', 'lavé', 'lavés'], answer: 1, explain: 'COD après → pas d’accord.' },
          { q: '« Nous sommes ___ à l’heure. »', options: ['arrivé', 'arrivée', 'arrivés'], answer: 2, explain: 'être + nous → arrivés.' },
        ],
      },
      {
        id: 'accords-genre',
        ...
        quiz: [
          { q: 'Pluriel de « travail » ?', options: ['travails', 'travaux', 'travau'], answer: 1, explain: 'travaux.' },
          { q: '« ___ problème reste. »', options: ['Une', 'Un', 'Des'], answer: 1, explain: 'problème est masculin.' },
          { q: 'Pluriel de « journal » ?', options: ['journals', 'journaux', 'journales'], answer: 1, explain: 'journaux.' },
        ],
      },
    ],
  },
